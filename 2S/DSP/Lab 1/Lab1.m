...
data points to produce a close approximation, instead representing an 'alias' to the original signal.
When we increase the signal to 10 or 15 khz, we see a much more faithful representation of the original
signal, since the faster sampling rate captures more data. This is an
example of aliasing - when a digital signal is reconstructed into an
'alias' that does not match the original analog signal. 
