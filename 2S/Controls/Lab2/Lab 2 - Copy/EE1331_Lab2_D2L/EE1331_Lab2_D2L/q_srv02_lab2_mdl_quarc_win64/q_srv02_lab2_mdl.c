...
void q_srv02_lab2_mdl_output(void)
{
  ...
  temp = 6.2831853071795862 * q_srv02_lab2_mdl_M->Timing.t[0];

  /* SignalGenerator: '<Root>/Signal Generator' */
  q_srv02_lab2_mdl_B.SignalGenerator = sin
    (q_srv02_lab2_mdl_P.SignalGenerator_Frequency * temp) *
...
RT_MODEL_q_srv02_lab2_mdl_T *q_srv02_lab2_mdl(void)
{
  ...
  /* External mode info */
  q_srv02_lab2_mdl_M->Sizes.checksums[0] = (703650385U);
  q_srv02_lab2_mdl_M->Sizes.checksums[1] = (2203800213U);
  q_srv02_lab2_mdl_M->Sizes.checksums[2] = (2098107145U);
  q_srv02_lab2_mdl_M->Sizes.checksums[3] = (22101162U);
