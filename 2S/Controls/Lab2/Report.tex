...
DC motors are an integral control system used across the world; understanding their performance is crucial to operating in many professional environments. This experiment offers a method to analyze the behavior of these control systems, using simulation software to generate frequency and step response plots. Verifying these plots with manual derivations allows a reasonable level of confidence when performing more abstract operations on the system response. This helps ensure that simulated models accurately represent the mathematical models that they are based on. We found very little difference between our simulated system parameters and those calculated by hand. Using this verified simulation to model our physical motor produced consistantly accurate results, with relatively minor differences in amplitude. Iterating through a range of values for the system parameters (such as gain \textit{$K$} and time constant \textit{$\tau$}), we were able to further improve the system's accuracy, until the differences between physical and simulated plots were negligible. This process is applicable in a variety of fields; allowing systems engineers to efficiently refine the performance of the systems they oversee. There are many possible avenues for further research into this topic, including methods to enhance a system's theoretical energy efficiency and sustainability.
